...
def create_pdf_report(output_path, logo_path, month_labels, month_values, month_means, month_stds, outliers):
    ...
    for i, month in enumerate(month_labels):
        ...
        pdf.cell(60, 8, f"{month_means[i]:.1f}", border=1, align="C")
        pdf.cell(60, 8, f"{month_stds[i]:.1f}", border=1, align="C")
        pdf.ln()
...
def main():
    ...
    def run_analysis():
        try:
            ...
            today = datetime.now()
            # FIXED: Use full 12 calendar months
