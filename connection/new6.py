#!/usr/bin/env python3
"""orb_homography_inspection_v18_unstable_hysteresis_tuned.py
...
UNSTABLE hysteresis (tuned)
---------------------------
- Enter UNSTABLE when ScoreMed <= 0.88
- Exit UNSTABLE only when ScoreMed >= 0.93
...
SCORE_UNSTABLE_ENTER = 0.88
SCORE_UNSTABLE_EXIT  = 0.93
